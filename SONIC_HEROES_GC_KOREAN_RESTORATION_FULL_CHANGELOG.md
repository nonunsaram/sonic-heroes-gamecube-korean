...
>
> 이 프로젝트는 존재하지 않았던 “공식 한국 GameCube 정발판”을 재현했다고 주장하지 않습니다.  
> 정확한 성격은 **일본판 GameCube 릴리스 내부에 남아 있던 Korean language path와 한국어 자산을 복원한 뒤, 별도의 Corrected 패치에서 이를 보수적으로 교정한 것**입니다.
